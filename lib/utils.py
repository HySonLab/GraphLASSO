...
def load_dataset(dataset_dir, batch_size, test_batch_size=None, **kwargs):
    ...
    #mean=data['x_train'][:,:,:,0].mean(axis=(0,1))
    #print(mean.shape)
    # std=data['x_train'][:,:,:,0].std(axis=(0,1))
    scaler = StandardScaler(mean=mean, std=std)
    # print(mean)
    # print(data['x_train'][:,:,:,0].mean().shape)
    ...
    #print("ALo: ", data['train_loader'][0,0,:5,:5])
    print("BLo: ", data['x_train'][0,0,:5,:5])
